...
Esta feature proporciona los elementos necesarios para seguir los ejemplos para aprender views de cambrico.net.
...
3. Instalar el modulo features desde la página de administración de módulos.
